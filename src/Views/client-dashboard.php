...
- تحسين SEO</textarea>
          ...
          <div style="grid-column:1/-1;">
            ...
            <textarea id="setting-product-description-instructions" rows="24">🧩 أهم نقطة: حدد نوع المنتج أولاً!
أمثلة: ملابس (رجالي/نسائي) | أحذية | إكسسوارات | إلكترونيات | أدوات منزلية | تجميلي

🧠 قواعد حسب نوع المنتج:
• ملابس: ركّز على الخامة، المقاس، الراحة، الاستخدام (يومي/رسمي)
...
🔗 الربط الداخلي:
استخدم 2-3 روابط فقط من نفس المتجر مرتبطة بالمنتج
مثال: رابط فئة + رابط براند + رابط منتج مشابه

🧱 هيكل الوصف (مهم جدًا):
1. مقدمة (بدون عنوان): تعريف بالمنتج + اسم + البراند + أهم ميزة
2. H2: نظرة عامة على المنتج: الشركة، الفئة، الاستخدام
3. H2: أهم المميزات: نقاط Bullet فقط
4. H2: المواصفات: معلومات مؤكدة فقط
5. H2: التصميم وجودة التصنيع: الشكل، الخامة، الراحة
6. H2: الأداء وتجربة الاستخدام: حسب نوع المنتج (مثال ملابس: الراحة، الحركة، الاستخدام اليومي)
7. H2: تقييمنا للمنتج: رأي واقعي بدون مبالغة
8. H2: طريقة الاستخدام: كيف يستخدم المنتج
9. H2: مقارنة مع منتجات مشابهة: فرق حقيقي فقط
10. H2: لماذا يختار العملاء هذا المنتج: نقاط إقناع
11. H2: لمن يناسب هذا المنتج: تحديد الجمهور
12. H2: لماذا تشتري من متجرنا: سرعة الشحن، جودة، ضمان
13. H2: منتجات قد تهمك: روابط داخلية فقط
14. H2: الأسئلة الشائعة: 5-7 أسئلة حقيقية
