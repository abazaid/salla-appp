...
4. **Create post file** — in `blog-src/src/content/posts/` with proper frontmatter (title, description, pubDate, tags)
5. **Build** — run `cd blog-src && npm run build`
6. **Publish** — git add, commit, and push to deploy
